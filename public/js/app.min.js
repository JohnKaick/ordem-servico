...
"use strict";!function(){function e(){var e=this;e.format="dd/MM/yyyy",e.opened=!1,e.open=function(){e.opened=!e.opened}}angular.module("app").controller("dateCtrl",e).directive("uiDate",function(){return{templateUrl:"/app/features/config/date.html",controller:e,scope:{ngModel:"=",required:"="}}})}();
...
"use strict";!function(){function e(e,a){var c=this;c.message="",c.salvar=function(t){a.create(e.chamadoSid,t).then(function(){c.message="Obrigado pelo feedback!"}).catch(function(e){c.message="Error: "+e})}}angular.module("app").controller("feedbackCtrl",e),e.$inject=["$routeParams","feedbackAPI"]}();
...
"use strict";!function(){function o(o,n,c){var t=this;t.usuario=n||{},t.salvar=function(n){n.id?c.update(n).then(function(){o.close()}).catch(function(o){console.log("Error:"+o)}):c.create(n).then(function(){o.close()}).catch(function(o){console.log("Error:"+o)})},t.cancelar=function(){o.dismiss()}}angular.module("app").controller("usuarioCadastroCtrl",o),o.$inject=["$uibModalInstance","usuario","usuarioAPI"]}();
"use strict";!function(){function o(o,r){function t(){r.getAll().then(function(o){u.lista=o.data}).catch(function(o){console.log("Error:"+o)})}var u=this;u.lista=[],u.usuario=usuario||{},u.load=t,u.cadastrar=function(){o.open({templateUrl:"app/usuario/usuario-cadastro.html",controller:"usuarioCadastroCtrl",resolve:{usuario:function(){return null}}}).result.then(function(){t()})},u.editar=function(r){o.open({templateUrl:"app/usuario/usuario-cadastro.html",controller:"usuarioCadastroCtrl",resolve:{usuario:function(){return angular.copy(r)}}}).result.then(function(){t()})},t()}angular.module("app").controller("usuarioCtrl",o),o.$inject=["$uibModal","usuarioAPI"]}();
